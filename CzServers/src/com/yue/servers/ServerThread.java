...
public class ServerThread extends Servers implements Runnable {
     ...
     * System version
     */
    public static final String VERSION = "v3-60996";

    //Safe Lock
    private static final ReentrantLock printLock = new ReentrantLock(true);
    private static final ReentrantLock closeLock = new ReentrantLock(true);
    private static final ReentrantLock refreshLock = new ReentrantLock(true);
