...
public class Servers extends JFrame {
	...
	//Safe Lock
	private static final ReentrantLock flagLock = new ReentrantLock(true);
	private static final ReentrantLock exitLock = new ReentrantLock(true);
	...
	public void initServersUI() {
		...
		setTitle("CzServer Version 3-60996");
